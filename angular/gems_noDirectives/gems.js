(function() {
  ...
  app.controller('StoreController', ['$http', function($http) {
    ...
    $http({
      method: 'JSONP',
      url: 'http://37.187.2.239:81/dwec/angular/products.php?callback=JSON_CALLBACK'
//      url: 'http://jacobosolvam.tk/dwec/angular/products.php?callback=JSON_CALLBACK'
  ...
  app.controller('productPanelsContoller', function() {
    this.tab = 1;
  ...
  app.controller('ejConScope', ['$scope', function($scope) {
    this.tab = 1;
    $scope.getInfo = function(evt) {  //en el ng-click tenemos que tener un getInfo($event)
 	console.log(evt.target);   
	console.log($(evt.target).attr("data-info"));     
      };
  }]);
