...
<head>
    ...
    <script type="text/javascript" src="js/cliente_accord2.js"></script>
    </head>

<body>
  
    <div style="position:relative; right: 0; bottom:0; height: 18%; width: 100%; background-color: #aaa; text-align:center;">
                <form style="background-color: #d0d9d9" enctype="multipart/form-data" action="uploader2.php" method="POST">
