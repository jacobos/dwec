...
function showCode(inThis){
//this works if you have the following structure
//you call the function from a <div> (or something with two children (probably not childNodes)
//the second child will react on the call (call the function: showCode(this))
	if(inThis.children[1].style.display == "none"){
		inThis.children[1].style.display = "block";
		inThis.children[1].style.border = "1px solid black";
	}
	else{
		inThis.children[1].style.display = "none";
	}
}
