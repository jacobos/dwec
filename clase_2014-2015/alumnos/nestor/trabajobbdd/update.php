...
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic">Product ID</label>
  <div class="col-md-4">
    <select id="productid" class="form-control">
      ...
      $query1="SELECT id_producto FROM productos"; 
                                $ej_query1=mysqli_query($conexion, $query1); 
                                while ($upd=mysqli_fetch_array($ej_query1)) {

				echo '<option value="'. $upd[0] . '">'. $upd[0] . '</option>';
			}
