<?php
	...
	$con=mysqli_connect("localhost","monaca","Alvaro1","monaca") or die('{"devuelve": "Error en conexion a la DB"}');


	//the usuario table should exist in your database
	
    $parametro = $_GET["info"];
    $result = mysqli_query($con,"SELECT * FROM City where District='$parametro'");
    $i = 0;
