module.controller('ModificarClieController', ['$scope', '$http',
...
var mostrar = function () {    //Para mostrar el listado de clientes
     ...
     url: 'http://javiergonzalez.tk/070/www/ListadoClientes.php?callback=JSON_CALLBACK'
        ...
        $scope.addClie = function (codigo,nombre,apellidos,telefono) { //Para insertar un registro
               ...
               $http({
                method: 'JSONP',
     url: 'http://javiergonzalez.tk/070/www/ModificarCliente.php?cod=' + codigo + ' &nom=' + nombre + '&apell=' + apellidos + '&tel=' + telefono
            }).success(function (data, status, headers, config) {
