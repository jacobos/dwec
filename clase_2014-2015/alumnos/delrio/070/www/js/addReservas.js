module.controller('addReservas', function ($scope, $http) {
       

        $scope.insertar = function (fecha, hora, nombre, apellidos, dni, tratamiento) { //Inserts
        
               $http({
                method: 'JSONP',
     url: 'http://webmasterstudio.tk/070/www/addReserva.php?fecha=' + $("#fecha").val() + ' &hora=' + $("#hora").val() + '&nombre=' + nombre  + '&apellidos=' + apellidos + '&dni=' + dni + '&tratamiento=' + tratamiento  
