(function() {
  ...
  var elementArray = [{
    ...
    fills: [{
      ...
      name: "AngularJS Gems",
      desc: "AngularJS gems",
      url: "http://jacobosolvam.tk/dwec/angular"
    }, {
      name: "AngularJS sillas",
      desc: "AngularJS sillas",
      url: "http://jacobosolvam.tk/dwec/angular/index_sillas.html"
    }, {
      name: "AngularJS Gems (without own Directives)",
      desc: "AngularJS Gems (no own directives)",
      url: "http://jacobosolvam.tk/dwec/angular/gems_noDirectives.zip",
      url2: "http://jacobosolvam.tk/dwec/angular/gems_noDirectives"
    }, {
      name: "AngularJS Gems (without Routing)",
      desc: "AngularJS Gems (no routing)",
      url: "http://jacobosolvam.tk/dwec/angular/gems_noRouting.zip",
      url2:"http://jacobosolvam.tk/dwec/angular/gems_noRouting"
    }, {
      name: "AngularJS Gems (with Routing)",
      desc: "AngularJS Gems (routing)",
      url: "http://jacobosolvam.tk/dwec/angular/gems_Routing.zip",
      url2: "http://jacobosolvam.tk/dwec/angular/gems_Routing"
    }, {
      ...
      url: "http://jacobosolvam.tk/dwec/angular/maps1.html",
    }, {
      name: "Extra, googleMaps2",
      desc: "an extra with google maps",
      url: "http://jacobosolvam.tk/dwec/angular/maps2.html",
    }]
  }, {
    orden: 21,
    name: "Other",
