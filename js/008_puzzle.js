...
(function () {
    ...
    function paint(imagen) {
        ...
        //we remove the granDiv element (after we create a new one, we 'clean' the body)
        ...
        for (i = 0; i < 9; i = i + 1) {
            ...
            //this line above is the same as the following commented lines
            // (we use it for the y position of the image (we are using the css sprite)
            /*
            if(i < 3){
                var_a_multiplicar = 0;
            }
    ...
    //we call the "paint" function with the value given (initially 1)
    paint(last_image);
}());